        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url();?>student/timetable/<?php @session_start(); echo $_SESSION['class']; ?>" class="nav-link">
                  <i class="fa fa-user" aria-hidden="true"></i>
                  <p>Timetable</p>
                </a>
              </li>
               ...
               <li class="nav-item">
                <a href="<?php echo base_url();?>student/attendance_status/<?php @session_start(); echo $_SESSION['id']; ?>" class="nav-link">
                  <i class="fa fa-user" aria-hidden="true"></i>
              ...
              <li class="nav-item">
                <a href="<?php echo base_url(); ?>student/event" class="nav-link">
                  <i class="fa fa-user" aria-hidden="true"></i>
                  <p>View Events</p>
                </a>
              </li>
               ...
               <li class="nav-item">
                <a href="<?php echo base_url(); ?>student/student_viewbook" class="nav-link">
                  <i class="fa fa-eye" aria-hidden="true"></i>
                  <p>View Library Books</p>
                </a>
              </li>
               <li class="nav-item">
                <a href="<?php echo base_url(); ?>student/viewMark/<?php @session_start(); echo $_SESSION['name']; ?>" class="nav-link">
                  <i class="fa fa-eye" aria-hidden="true"></i>
                  <p>View Marks</p>
                </a>
              </li>
