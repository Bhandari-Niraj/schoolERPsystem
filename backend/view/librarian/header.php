  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo base_url(); ?>/student/dashboard" class="brand-link">
      <img src="<?php echo base_url(); ?>public/dist/img/AdminLTELogo.png"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">Librarian</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo base_url();?>staff/library_dashboard" class="nav-link">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
               ...
               <li class="nav-item">
                <a href="<?php echo base_url();?>staff/view_book" class="nav-link">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url();?>staff/borrow" class="nav-link">
                  <i class="fa fa-eye" aria-hidden="true"></i>
                  <p>Borrower Detail</p>
                </a>
              </li>
